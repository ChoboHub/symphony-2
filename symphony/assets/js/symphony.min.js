...
if(!(t<2))throw w;c(-1,w)}}else c(-1,"No Transport");return v},getJSON:function(a,b,c){return _.get(a,b,c,"json")},getScript:function(a,b){return _.get(a,void 0,b,"script")}}),_.each(["get","post"],function(a,b){_[b]=function(a,c,d,e){
...
if(b)throw h}},abort:function(){b&&b()}}}),
...
return a?void 0!==typeof e.Context[a]&&e.Context[a]:e.Context}},/**
...
for(var d=e.find(f.items+":not(.collapsed)"),g=b.Utilities.inSight(d),h=a(),j=a(window).scrollTop(),k=g.eq(0).index(),l=0;k<d.length&&l<window.innerHeight;){var m=d.eq(k);g=g.add(m),l+=m.data("heightMin"),k++}g.each(function(){i(a(this),f.delay)}),setTimeout(function(){var b=g.eq(0),c=b.offset().top;
...
// Down
40==b.which?(b.preventDefault(),s(d)):38==b.which?(b.preventDefault(),r(d)):27==b.which?(b.preventDefault(),d.blur()):13==b.which&&(b.preventDefault(),
//***
c=d.next(".suggestions").find("li:not(.help).active").text(),c&&o(c,d))},i=function(b){var c=a(b.target),d=c.parent(".suggestions").prev("input"),e=t(c);o(e,d)},j=function(a,b,c,d){var e=a[0].selectionStart||0,f=c.substring(0,e).split(" "),g=c.substr(e).split(" "),h=f[f.length-1],i=f[f.length-1]+g[0];
// Token found
...
q(d),
// Add suggestions
c.entries&&(f=c.entries.filter(function(a,b,c){return c.indexOf(a)===b}),a.each(f,function(b,c){var f=a("<li />",{text:c.value,"data-value":c.key});e?f.insertBefore(e):d.append(f)}),b.replaceWith(d))},n=function(a){var b=a.next(".suggestions"),c=b.find(".calendar");c.length||v(b)},o=function(a,b){var c=b.attr("data-search-types");c&&c.indexOf("parameters")!==-1?p(a,b):(a=a.replace(/,/g,"\\,").replace(/&/g,"%26"),b.val(a),b.addClass("updated"),b.change()),q(b.next(".suggestions"))},p=function(a,b){var c=b.val(),d=b[0].selectionStart||0,e=c.substring(0,d).split(" "),f=c.substr(d).split(" "),g="",h="";
...
// First
0===c.length||0===d.length?b.find("li:not(.help)").last().addClass("active"):d.addClass("active"),w(b)},s=function(a){var b=a.next(".suggestions"),c=b.find("li:not(.help).active").removeClass("active"),d=c.next("li:not(.help):visible");
// First
0===c.length||0===d.length?b.find("li:not(.help)").first().addClass("active"):d.addClass("active"),w(b)},t=function(a){},u=function(b){var d=c.find(b);d.each(function(){var b,c,d=a(this),e=d.next(".suggestions");e.length||(b=a('<ul class="suggestions" />'),c=d.attr("data-search-types"),c&&b.attr("data-search-types",c),b.insertAfter(d))})},v=function(a){var c=new b.Interface.Calendar;a.prepend('<li class="calendar" data-format="YYYY-MM-DD" />'),c.init(a.parents("label"))},w=function(a){var b,c=a.find("li.active");
// Get distance
...
c=a(this).find("input").map(function(a){return this.name+"="+(a+1)}).get().join("&")}).on("orderstop.orderable",function(){var e=d.find("input").map(function(a){return this.name+"="+(a+1)}).get().join("&");
// Store sort order, if changed
d.addClass("busy"),null!==c&&e!==c?(
// Update items
d.trigger("orderupdate.admin"),
// Add XSRF token
e=e+"&"+b.Utilities.getXSRF(!0),
// Send request
a.ajax({type:"POST",url:b.Context.get("symphony")+"/ajax/reorder"+b.Context.get("route"),data:e,error:function(){b.Message.post(b.Language.get("Reordering was unsuccessful."),"error")},complete:function(){d.removeClass("busy").find("tr").removeClass("selected")}})):d.removeClass("busy")}),
// Suggest
